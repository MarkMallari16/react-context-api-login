...
const Sidebar = ({ isSideBarExpand, handleSideBarExpand }) => {
    ...
    return (
        <div className={`fixed top-0 left-0 z-10 h-full ring-1 bg-white ring-slate-300 p-4 lg:px-4 lg:py-5 ${isSideBarExpand ? 'w-80' : 'w-24 '} duration-500 ease-in-out rounded-r-xl `} >
