...
const Sidebar = () => {
    ...
    return (
        <div className={`ring-1 ring-slate-300 px-4 py-5 rounded-r-xl sticky transition-all duration-300 ease-in-out ${isSideBarExpand ? 'w-96' : 'w-auto'}`}>
            ...
            <div >
                ...
                <div className='flex  flex-col space-y-4 pt-10'>
                    <div className='px-5 py-3 flex gap-3 w-full bg-blue-500 text-white font-medium rounded-lg cursor-pointer'>
                    ...
                    <div className={`px-5 py-3 flex gap-3 ${isSideBarExpand ? ' w-full' : 'w-auto'} cursor-pointer hover:bg-slate-200 rounded-lg transition-all`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    ...
                    <div className='px-5 py-3 flex gap-3  w-full cursor-pointer hover:bg-slate-200 rounded-lg transition-all'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
