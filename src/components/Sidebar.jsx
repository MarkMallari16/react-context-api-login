...
const Sidebar = () => {
    ...
    return (
        <div className={`ring-1 ring-slate-300 p-4 lg:px-4 lg:py-5 relative  ${isSideBarExpand ? 'w-96' : 'w-24 '} duration-500 ease-in-out rounded-r-xl`} >
            <div className={`absolute top-64 ${isSideBarExpand ? '-right-4' : '-right-4 rotate-180'} bg-blue-500 rounded-full cursor-pointer p-1 text-white transition-all  duration-500 ease-in-out`} onClick={handleSideBarExpand}>
