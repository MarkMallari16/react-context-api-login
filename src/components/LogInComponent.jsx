    ...
    return (
        <div className='min-h-screen grid grid-cols-1 lg:grid-cols-2 place-items-center '>
            ...
            <div className='h-full  flex justify-center items-center '>
                <div className='w-full mx-10 lg:mx-24 border p-12 rounded-lg'>
                    {logoutMessage &&
                    ...
                    <div>
                        ...
                        <p className='text-slate-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis, ad!</p>
                    </div>
                    <div className='mt-4'>
